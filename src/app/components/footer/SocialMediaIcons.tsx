...
export default function SocialMediaIcons({ socialMedia, className = '' }: SocialMediaIconsProps) {
  const visibleSocialMedia = socialMedia
    .filter(social => social.visible)
    .sort((a, b) => a.position - b.position);

  if (visibleSocialMedia.length === 0) {
    return null;
  }
    ...
    <div className={`flex items-center space-x-3 ${className}`}>
      {visibleSocialMedia.map((social) => (
        ...
        >
          ...
          <div className="w-10 h-10 bg-gray-700 hover:bg-blue-600 rounded-full flex items-center justify-center transition-all duration-300 transform hover:scale-110 hover:shadow-lg group-hover:shadow-xl">
            ...
            {!['facebook', 'instagram', 'twitter', 'youtube', 'linkedin', 'tiktok', 'whatsapp'].includes(social.platform.toLowerCase()) && (
